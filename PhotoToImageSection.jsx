...
const PhotoToImageSection = () => {
    ...
    const handleFileChange = (file) => {
        ...
        // Check if file is an image. No dimension restriction here -- the backend
        // automatically resizes/crops any uploaded image to a size Stability AI accepts,
        // so any photo of any size or aspect ratio can be uploaded.
